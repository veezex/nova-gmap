...
Nova.booting(function (Vue, router) {
    Vue.component('index-nova-gmap', __webpack_require__(3));
    Vue.component('detail-nova-gmap', __webpack_require__(6));
    Vue.component('form-nova-gmap', __webpack_require__(9));
});
